    ...
    if code not in range(200, 300):
        ...
        for order in order_result_list: 
            ...
            if code not in range(200, 300):
                ...
                body=message)
                final_result_list.append({'pname':product_result['data']['pname'], 'imgname':product_result['data']['imgname'], 'dStatus': order['dStatus'], 'datetime':order['datetime'], 'oStatus': order['oStatus'], 'quantity': order['quantity'], 'dStatus': order['dStatus'] })
